...
final class UiText {
    ...
    private static void addFormTranslations(Map<String, String> values) {
        ...
        put(values, "Show password", "Hiển thị mật khẩu");
        ...
        put(values, "Register once, then sign in as a bidder or seller.", "Đăng ký một lần rồi đăng nhập với vai trò người đấu giá hoặc người bán.");
    ...
    private static void addRuntimeTranslations(Map<String, String> values) {
        ...
        put(values, "Admin accounts cannot be created from registration.", "Không thể tạo tài khoản quản trị từ màn hình đăng ký.");
    ...
    private static void addServiceTranslations(Map<String, String> values) {
        ...
        put(values, "Default admin password is fixed and cannot be changed.", "Mật khẩu quản trị mặc định được cố định và không thể thay đổi.");
        ...
        put(values, "Only the default admin can promote accounts to admin.", "Chỉ quản trị mặc định mới có thể nâng tài khoản lên quản trị.");
        put(values, "Only the default admin can demote admin accounts.", "Chỉ quản trị mặc định mới có thể hạ quyền quản trị.");
        put(values, "Account for promotion was not found.", "Không tìm thấy tài khoản để nâng quyền.");
        put(values, "Account for demotion was not found.", "Không tìm thấy tài khoản để hạ quyền.");
        put(values, "The default admin account is already the super admin.", "Tài khoản quản trị mặc định đã là super admin.");
        put(values, "The default admin account cannot be demoted.", "Không thể hạ quyền tài khoản quản trị mặc định.");
        put(values, "Account is already an admin.", "Tài khoản này đã là quản trị viên.");
        put(values, "Only admin accounts can be demoted.", "Chỉ tài khoản quản trị mới có thể bị hạ quyền.");
        put(values, "Account promoted to admin successfully.", "Đã nâng tài khoản lên quản trị viên thành công.");
        put(values, "Admin account demoted successfully.", "Đã hạ quyền tài khoản quản trị thành công.");
        put(values, "PROMOTE ADMIN", "NÂNG LÊN QUẢN TRỊ");
        put(values, "DEMOTE ADMIN", "HẠ QUYỀN QUẢN TRỊ");
