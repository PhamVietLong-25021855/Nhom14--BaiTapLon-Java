...
public class HomeAnnouncementCardController {
    ...
    public void setAnnouncement(HomepageAnnouncement announcement, AuctionItem linkedAuction) {
        ...
        lblTitle.setText(safeValue(announcement.getTitle(), "Thong bao"));
        lblSummary.setText(safeValue(announcement.getSummary(), ""));
        lblSchedule.setText("Lich dang: " + safeValue(announcement.getScheduleText(), "-"));
        lblUpdatedAt.setText("Cap nhat luc: " + AuctionViewFormatter.formatDateTime(announcement.getUpdatedAt()));
        ...
        if (hasLinkedAuction) {
            lblLinkedAuctionTitle.setText("Vat pham lien ket: " + safeValue(linkedAuction.getName(), "-"));
            lblLinkedAuctionSchedule.setText("Khung gio: " + AuctionViewFormatter.formatScheduleRange(linkedAuction));
        }
    }
