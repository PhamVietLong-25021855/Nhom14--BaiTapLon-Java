...
// Khai bao lop AuctionClosedException; dai dien mot tinh huong loi nghiep vu cu the.
public class AuctionClosedException extends Exception {
    // Thuoc tinh/hang so: luu cau hinh hoac gia tri dung chung cho serial version uid.
    private static final long serialVersionUID = 1L;
    // Ham tao: khoi tao doi tuong AuctionClosedException voi cac phu thuoc can thiet.
