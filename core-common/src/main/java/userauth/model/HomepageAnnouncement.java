...
public class HomepageAnnouncement extends Entity {
    ...
    public int getLinkedAuctionId() { return linkedAuctionId; }
    public void setLinkedAuctionId(int linkedAuctionId) { this.linkedAuctionId = linkedAuctionId; }
    ...
    public boolean hasLinkedAuction() { return linkedAuctionId > 0; }
}
