...
public class AuctionItem extends Item {
    ...
    public AuctionItem(int id, String name, String description, double startPrice, double currentHighestBid,
        ...
        this(id, name, description, startPrice, currentHighestBid, startTime, endTime, category, null, null, createdAt, updatedAt, sellerId, winnerId, status, 0);
    }
    ...
    public AuctionItem(int id, String name, String description, double startPrice, long startTime, long endTime,
        ...
        this(id, name, description, startPrice, startPrice, startTime, endTime, category, imageSource, imageData,
                System.currentTimeMillis(), System.currentTimeMillis(), sellerId, -1, AuctionStatus.OPEN, 0);
    }
    ...
    public String toString() {
        return id + "," + name + "," + description + "," + startPrice + "," + currentHighestBid + "," + startTime + "," + endTime + "," + category + "," + imageSource + "," + createdAt + "," + updatedAt + "," + sellerId + "," + winnerId + "," + (status != null ? status.name() : "null") + "," + antiSnipingExtensionCount;
    }
}
