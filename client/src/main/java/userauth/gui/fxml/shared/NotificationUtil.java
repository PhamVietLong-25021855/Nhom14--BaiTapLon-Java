...
import userauth.gui.fxml.dialog.ModalMessageController;
import userauth.gui.fxml.dialog.TextInputDialogController;
import userauth.gui.fxml.dialog.ToastNotificationController;
...
public final class NotificationUtil {
    ...
    public static boolean confirm(Window owner, String title, String message) {
        LoadedView<ModalMessageController> view = FxmlRuntime.loadView(NotificationUtil.class, "dialog/modal-message.fxml", "dialog");
    ...
    public static String input(Window owner, String title, String message, String defaultValue) {
        LoadedView<TextInputDialogController> view = FxmlRuntime.loadView(NotificationUtil.class, "dialog/text-input-dialog.fxml", "dialog");
        String localizedTitle = UiText.text(title);
        String localizedMessage = UiText.text(message);
    ...
    private static void showToast(Window owner, String title, String message, String toneStyleClass) {
        ...
        LoadedView<ToastNotificationController> view = FxmlRuntime.loadView(NotificationUtil.class, "dialog/toast-notification.fxml", "toast");
